...
Spatial-domain identification is a central task in spatial transcriptomics, but individual spatial clustering methods can vary across tissue contexts because they rely on different assumptions about gene expression, spatial continuity, and representation learning. TRUST-ST is a multi-level reliability-guided consensus clustering framework that integrates several imperfect base partitions into a more reliable spatial-domain assignment.

TRUST-ST models reliability at three levels: method redundancy, individual cluster units, and spot pairs. The framework combines **Method Decorrelation**, split-entropy-based **Cluster Reliability**, an **Adaptive Consensus Gate**, and **Conservative Spatial Refinement**. Instead of aggregating all method votes uniformly, TRUST-ST identifies reliable consensus evidence and selectively corrects ambiguous co-association signals.
